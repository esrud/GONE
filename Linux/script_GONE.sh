...
echo "TOTAL NUMBER OF SNPs" >> PARAMETERS_$FILE
cat nsnp >> PARAMETERS_$FILE
echo -e "\n" >> PARAMETERS_$FILE
echo "HARDY-WEINBERG DEVIATION" >> PARAMETERS_$FILE
cat outfileHWD >> PARAMETERS_$FILE
echo -e "\n" >> PARAMETERS_$FILE
