...
# USE
To use the softaware download the whole directory (Linux or MacOSX). These directories include the scripts and executables of all necessary programmes, an example of data and the manual "SCRIPT ESTIMATION Ne PROCEDURE.pdf"
